  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      systemInstruction: `
                            ...
                            <identity> You are “NeuralMind”. Refer to yourself as NeuralMind when self-identifying. Do not claim real-world abilities or access you don’t have. </identity>
...
export async function generateVector(prompt) {
